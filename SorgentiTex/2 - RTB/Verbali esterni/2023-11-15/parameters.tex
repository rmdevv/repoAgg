...
{Breve introduzione per discutere in modo generale cosa ci si aspetta che il software debba saper fare;},
{Raccolta requisiti generali di progetto per una iniziale stesura dell'Analisi dei requisiti;},
...
{Certamente la ricezione in input e la gestione dei documenti, deve essere efficiente;
},
\domris
{Quali funzionalità principali dovremmo rendere disponibili per il caricamento dei documenti?
}
{Sicuramente il sistema dovrà essere capace di ricevere in input ed elaborare documenti \textit{PDF}; cadrebbe tra i requisiti desiderabili anche il caricamento di documenti \textit{Word} e, nel caso il prodotto prendesse piede, il caricamento massivo di documenti;
},
\domris
...
{L'azienda ci ha confermato che se un manuale dato al sistema subisce modifiche o viene eliminato, a fronte di una evoluzione del macchinario a cui si riferisce, il sistema dovrà evolvere ed essere riaddestrato;
},
\domris
{Altre specifiche dell'interazione tra l'utente e il \textit{chatbot}?
}
{L'utente dovrà poter chattare con molta semplicità e ricevere risposte pertinenti basate sui documenti documenti caricati a sistema, tuttavia, all'utente non sarà permesso di fare domande non attinenti al proprio lavoro (ad esempio: "Quali sono le previsioni meteo per domani?"). Un requisito che interessa particolarmente alla azienda è la possibilità di comunicare a voce con il sistema e di ricevere output vocali. Non è necessario avere la possibilità di avere più chat contemporaneamente ma è desiderabile avere uno storico delle cose chieste.}.
}
